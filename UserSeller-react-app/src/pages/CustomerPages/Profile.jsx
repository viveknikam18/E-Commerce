 ...
 <Box sx={{ flexGrow: 1 }}>
    ...
    <Box sx={{p:3}}>
        <Typography variant='h5' gutterBottom>
            ...
            <Typography><strong>First Name:  </strong>{userData.firstName || 'N/A'}</Typography>
            <Typography><strong>Last Name:  </strong>{userData.lastName || 'N/A'}</Typography>
            ...
            <Button sx={{backgroundColor:"blue", color:'black', marginTop:"20px"}} onClick={()=>{navigate('/')}}>Logout</Button>
    </Box>
</>  
  )
}
